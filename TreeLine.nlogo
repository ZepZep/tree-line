...
;  import-drawing "data/cr-lines.png"
;  clear-drawing

  set-default-shape pines    "tree pine"
  set-default-shape scrubs   "plant medium"
  set-default-shape grass    "plant small"
...
to apply-map
  set img-bg (word "maps/" map-chooser "-bg.png")
  set img-patch (word "maps/" map-chooser "-patch.png" )
;  show img-bg

  import-pcolors img-patch
end
...
to populate-random
  ask patches [
    ...
    (ifelse
    choice = 0
      [ sprout-pines   1 [set color green - 2] ]
    choice = 1
      [ sprout-scrubs  1 [set color green ] ]
    [ sprout-grass  1 [set color green + 2] ]
    )
  ]
end
...
to populate-height
  ask patches [
    ...
    (ifelse
    pcolor >= 3
      [ sprout-scrubs  1 [set color turquoise - 3 ] ]
    pcolor >= 1.5
      [ sprout-pines   1 [set color green - 2 ] ]
;    [ sprout-grass  1 [set color green + 2] ]
    )
...
"pen-1" 1.0 0 -13210332 true "" "plot count pines"
"pen-2" 1.0 0 -15973838 true "" "plot count scrubs"
